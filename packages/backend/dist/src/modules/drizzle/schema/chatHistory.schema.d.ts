export declare enum ChatHistoryRole {
    HUMAN = "human",
    AI = "ai"
}
export declare const chatHistories: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "chat_history";
    schema: undefined;
    columns: {
...
export declare const chatHistoriesRelations: import("drizzle-orm").Relations<"chat_history", {
